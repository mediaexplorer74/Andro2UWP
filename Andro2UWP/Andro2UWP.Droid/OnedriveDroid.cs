...
namespace Uno.OneDrive
{
    ...
    internal interface IDependency
    {
        ...
        Task<Microsoft.Identity.Client.AuthenticationResult> GetAuthResult
    ...
    internal class Dependency
    {
        ...
        static Lazy<IDependency> implementation = new Lazy<IDependency>(
    ...
    internal partial class ConnectorHandler : DelegatingHandler
    {
        ...
        private async Task<HttpResponseMessage> InnerConnectionHandlerAsync(HttpRequestMessage request, 
            CancellationToken cancellationToken)
        {
            try
            {
